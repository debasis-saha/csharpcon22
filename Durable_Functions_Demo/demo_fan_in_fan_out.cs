...
{
    public static class fan_in_fan_out_demo
    {
        [FunctionName("fn_backup_content")]
            ...
            [OrchestrationTrigger] IDurableOrchestrationContext context)
        {
            ...
            {
                rootDirectory = Directory.GetParent(typeof(fan_in_fan_out_demo).Assembly.Location).FullName;
            }
        ...
        [FunctionName("fn_fetch_file_list")]
        ...
        [FunctionName("fn_copy_file_to_blob")]
